          ...
          <ul className="space-y-1">
            {categories.map((cat, index) => (
              <li 
                ...
                className={`px-4 py-2 rounded-md cursor-pointer transition-colors hover:bg-primary hover:text-white ${index === 0 ? 'bg-primary-light font-medium text-dark' : 'text-dark-light hover:bg-shade'}`}
              >
                {cat}
              </li>
            ))}
